...
public class Draaimolen : Interactable
{
    ...
    public override void OnInteract(Interactor interactor)
    {
        ...
        totalTimer = 0f;
        display = Instantiate(displayModel, boneMirror);
        display.transform.localPosition = new Vector3(-0.29f, 0.553f, -0.53f);
    ...
    public override void InteractableUpdate()
    {
        ...
        boneMirror.localRotation = Quaternion.Euler(0, bone.rotation.eulerAngles.y, 0);
